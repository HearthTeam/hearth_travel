  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">oppure <u>scegli un file</u></div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Sostituisci immagine">Sostituisci</button>' +
        '  <button data-act="edit" title="Riquadra immagine">Riquadra</button></div>' +
